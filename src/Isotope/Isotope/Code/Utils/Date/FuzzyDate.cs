...
public partial struct FuzzyDate : IEquatable<FuzzyDate>, IComparable<FuzzyDate>
{
    ...
    [GeneratedRegex(@"^(?<year>[0-9]{3}[0-9?]|\?{4})(\.(?<month>[0-9]{2}|\?\?)(\.(?<day>[0-9]{2}|\?\?))?)?$", RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture | RegexOptions.Compiled, "ru-RU")]
    ...
    {
        return string.Compare(CanonicalString, other.CanonicalString, CultureInfo.InvariantCulture,
            CompareOptions.None);
    }
