...
public static class ImageHelper
{
    ...
    {
        [MediaSize.Small] = new ImagePreset(MediaSize.Small, new Size(200, 200), ResizeToFill, new JpegEncoder { Quality = 80 }),
        [MediaSize.Large] = new ImagePreset(MediaSize.Large, new Size(1024, 768), ResizeToFit, new JpegEncoder { Quality = 90 })
    };
...
public record ImagePreset(MediaSize MediaSize, Size Size, Func<Image, Size, Image> ResizeFunc, IImageEncoder Codec);