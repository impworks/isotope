...
/// </summary>
public class RebuildInheritedTagsJob(AppDbContext db) : JobBase
{
    protected override async Task ExecuteAsync(CancellationToken token)
    {
        ...
        await db.MediaTags.RemoveWhereAsync(x => x.Type == TagBindingType.Inherited);
        db.MediaTags.AddRange(tags);
